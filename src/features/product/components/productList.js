...
const ProductList = () => {
  ...
  const error = useSelector((state) => state.product.status === 'failed');
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500 text-left">
                      <StarIcon className="w-5 h-5  text-yellow-500 inline"></StarIcon>
          ...
          {/* section of products & filters end here  */}
